import questionary, requests, time
...
def topologiaPredeterminada(usuarioLog, endpointBase):
    ...
    if(opcion =="5. Salir"):
        ...
        if opcion == "4. Lineal":
            VMsDetalladas = [recurso.VM("vm1","1024","2","cirros.img"), 
                             recurso.VM("vm2","1024","2","cirros.img"),
                             recurso.VM("vm3","1024","2","cirros.img")]
        else:
            VMsDetalladas = [recurso.VM("vm1","1024","2","cirros.img"), 
                             recurso.VM("vm2","1024","2","cirros.img"),
                             recurso.VM("vm3","1024","2","cirros.img"),
                             recurso.VM("vm4","1024","2","cirros.img")]
        slice = {"vms": VMsDetalladas, "switches": listaSWs, "enlaces":listaEnlaces}  
